...
function skt_full_width_scripts() {
	...
	wp_enqueue_style( 'skt_full_width-sized-default-theme', get_template_directory_uri()."/css/sized.css" );
	
	wp_enqueue_style( 'skt_full_width-shutter-style', get_template_directory_uri()."/css/shutter.css" );
	
	wp_enqueue_script( 'skt_full_width-slider', get_template_directory_uri() . '/js/shutter.min.js', array('jquery') );

	wp_enqueue_script( 'skt_full_width-shutter', get_template_directory_uri() . '/js/shutter.js', array('jquery') );
